...
var resizePizzas = function(size) {
  ...
  //for the function changePizzaSize, only calculate newwidth once.
...
// The calculation is put outside the for loop to safe time
  var items = document.querySelectorAll('.mover');
  var cal = Math.sin((document.body.scrollTop / 1250));
  for (var i = 0; i < items.length; i++) {
    var phase = (cal + (i % 5)) * 100;
